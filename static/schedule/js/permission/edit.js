window.addEventListener("load", function () {
    ...
    permission_form_edit_add.addEventListener("click", () => {
        ...
        console.log(document.querySelector("#permission_form_init_area"));
        console.log(permission_form_init_area);

        // 各valueの値を書き換える。
        permission_form_init_area.querySelector("[name='authority']").value =
            value;
        ...
        permission_form_init_area.querySelector(
            "[name='write']"
        ).checked = true;
        ...
        // 全ての入力フォームの削除ボタンを取得する
        delete_btns = permission_form_last.querySelectorAll(
            "[name='delete_btn']"
        );
